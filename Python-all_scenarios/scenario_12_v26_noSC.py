...
from function_irrad_to_power_pros25 import energy_offer
...
num_hours = 24
num_seller = 25 # declare the number of sellers
...
panels_num = np.array([5, 10, 5, 5, 10, 5, 5, 25, 10, 5, 5, 5, 15, 5, 10,\
                       10, 5, 10, 10, 25, 5, 10, 5, 10, 5]) # number of panels each prosumer has - they denote also his PV capacity
