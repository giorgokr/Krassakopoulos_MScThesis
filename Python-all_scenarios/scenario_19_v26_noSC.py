...
from function_irrad_to_power_pros35 import energy_offer
...
num_hours = 24
num_seller = 35 # declare the number of sellers
...
panels_num = np.array([5, 10, 5, 5, 10, 5, 5, 25, 10, 5, 5, 5, 15, 5, 10,\
                       ...
                       5, 25, 10, 10, 5]) # number of panels each prosumer has - they denote also his PV capacity
...
bmax = np.array([1.2, 3.3, 0, 1.2, 0, 4.2, 0, 9.7, 6, 0, 0, 0, 5, 2, 3.3, 0, 2, 6, 0, 13.5,\
                 1.2, 0, 2, 3.3, 0, 0, 0, 5, 3.3, 1.2, 0, 19.4, 6, 0, 1.2])  
