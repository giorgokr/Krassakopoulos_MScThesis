...
num_hours = 24
num_seller = 20 # declare the number of sellers
...
panels_num = np.array([25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25]) # for 10 kW array capacity 
#panels_num = np.array([15, 15, 15, 15, 15]) # for 6 kW array capacity 
#panels_num = np.array([10, 10, 10, 10, 10]) # for 4 kW array capacity 
#panels_num = np.array([5, 5, 5, 5, 5]) # for 2 kW array capacity 
...
for day in range(num_days):
    for hour in range(num_hours):
        ...
        for agent_s in range(0, 5): # from 0 to 4, to make it put pros of the same region by 5 in "energy_gen" 
