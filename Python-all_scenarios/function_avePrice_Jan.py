...
#in every hour
#so I can find the average price of the new year holiday period and use it as the start, 
#for hour = 0 and day = 0  for the EMA in my main file
#I consider the average price of 1 week before the 1st Jan and 1 week after the 1st Jan which is the school 
#holidays in Greece and have the biggest loads
...
#when you have the final data, make this find the average Price for 1 week before and 1 week after the 1st of Jan.

def avePrice_J(num_days, num_hours, num_seller, num_buyer):
