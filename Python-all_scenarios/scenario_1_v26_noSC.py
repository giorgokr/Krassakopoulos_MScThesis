...
from function_irrad_to_power_pros15 import energy_offer
...
num_hours = 24
num_seller = 15 # declare the number of sellers
...
panels_num = np.array([5, 10, 5, 5, 10, 5, 5, 25, 10, 5, 5, 5, 15, 5, 10]) # number of panels each prosumer has - they denote also his PV capacity
...
for day in range(num_days):
    for hour in range(num_hours):
        ...
        #conPayDSO_MAX_euro = 0.5 #the max price the retail utility may ask per kWh
