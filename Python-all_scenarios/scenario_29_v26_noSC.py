...
from function_irrad_to_power_pros50 import energy_offer
...
# number of panels each prosumer has - they denote also his PV capacity    
panels_num = np.array([5, 10, 5, 5, 10, 5, 5, 25, 10, 5, 5, 5, 15, 5, 10,\
                       10, 5, 10, 10, 25, 5, 10, 5, 10, 5, 10, 10, 15, 5, 5,\
                       5, 25, 10, 10, 5, 10, 15, 5, 5, 5, 5, 5, 25, 5, 5,\
                       5, 5, 5, 5, 5]) 
